    ...
    return (
        <div className="app-container">
            ...
            <div className="main-layout main-content" id="main-content">
                ...
                <div className="passwords-container passwords-section">
                    {/* Sabit Başlık */}
                    ...
                    {isLoading ? (
                        ...
                        <div className="empty-state">
                            <div className="empty-icon">📝</div>
                            <p className="empty-title">
                                Henüz hiç şifre kaydı yapılmamış
                            </p>
                            <p className="empty-subtitle">
                                Soldaki formu kullanarak ilk şifrenizi ekleyin!
                            </p>
                        </div>
                    ) : (
                    ...
                    </div> {/* Scrollable İçerik Alanı Kapanışı */}
                </div>
            </div>
